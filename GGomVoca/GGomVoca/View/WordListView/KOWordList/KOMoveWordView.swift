...
struct KOMoveWordView: View {
    @StateObject var vocaListViewModel = VocabularyListViewModel(vocabularyList: [])
    @StateObject var selectedVocaviewModel: KOWordListViewModel = KOWordListViewModel()
    @ObservedObject var currentVocaViewModel: KOWordListViewModel
    ...
    var body: some View {
        List {
            Section {
                ForEach(vocaListViewModel.koreanVoca) { vocabulary in
                    Button {
...
//struct KOMoveWordView_Previews: PreviewProvider {
