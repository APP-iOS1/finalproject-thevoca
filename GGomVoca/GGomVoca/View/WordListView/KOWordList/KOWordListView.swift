...
struct KOWordListView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $moveWord) {
            KOMoveWordView(currentVocaViewModel: viewModel, isSelectionMode: $isSelectionMode, multiSelection: $multiSelection, moveWord: $moveWord, currentVocaID: vocabularyID)
