...
struct JPMoveWordView: View {
    @StateObject var vocaListViewModel = VocabularyListViewModel(vocabularyList: [])
    @StateObject var selectedVocaviewModel: JPWordListViewModel = JPWordListViewModel()
    @ObservedObject var currentVocaViewModel: JPWordListViewModel
    ...
    var body: some View {
        List {
            Section {
                ForEach(vocaListViewModel.japaneseVoca) { vocabulary in
                    Button {
...
//struct JPMoveWordView_Previews: PreviewProvider {
