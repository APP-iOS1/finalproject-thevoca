...
struct JPWordListView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $moveWord) {
            JPMoveWordView(currentVocaViewModel: viewModel, isSelectionMode: $isSelectionMode, multiSelection: $multiSelection, moveWord: $moveWord, currentVocaID: vocabularyID)
